        ...
        body: Stack(
          children: [
            Container(
              ...
              child: const Text("Welcome \n to  Contact",style: TextStyle(color: Colors.cyan,fontSize: 25,fontWeight: FontWeight.w700),),
            ),
            SingleChildScrollView(
              ...
              child: Column(children: [
                ...
                Row(
                  ...
                  children: [
                    const Text("Sign in",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.green),),
                    CircleAvatar(radius: 25,backgroundColor: Colors.green,child: IconButton(color: Colors.white70,onPressed: (){
                      Navigator.pushNamed(context, 'appbar');},icon: const Icon(Icons.arrow_forward),),)
                  ],
                ),
